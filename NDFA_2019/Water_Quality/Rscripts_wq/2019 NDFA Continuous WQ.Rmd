...
RMB <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_RMB.csv")
RCS <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_RCS.csv")
RD22 <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_RD22.csv")
I80 <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_I80.csv")
LIS <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_LIS.csv")
STTD <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_STTD.csv")
TOE <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_TOE.csv")
LIB <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_LIB.csv")
RYI <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_RYI.csv")
RVB <- read.csv("C:/Users/bedavis/OneDrive - California Department of Water Resources/My Documents/Special Studies/Internal/NDFA/2019 NDFA/Continuous Water Quality-NCRO/NDFA 2019 continuous_RVB.csv")
...
ggplot(data=CWQ, aes(x=time,y=Chl,colour=factor(Station),group=Station))+geom_line(size=.2)+theme_bw()+scale_x_datetime("Date 2019",breaks=date_breaks("96 hour"), labels=date_format("%m/%d")) +theme(axis.text.x=element_text(angle=90))+
  ...
  annotate("rect", xmin = CWQ$time[1800], xmax = CWQ$time[4471], ymin = 0.1, ymax = 175,alpha = .2)+ 
